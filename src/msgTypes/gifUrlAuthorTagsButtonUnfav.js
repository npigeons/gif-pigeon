...
// 	return data.mainUrl && msg.content.includes('Tags:') && msg.components.length === 1 && msg.components[0].components.length === 2 && msg.components[0].components[0].customId === 'remove-from-favourites-button';
// }
